...
def book_details(request, book_id):
    ...
    if (
        ...
        # return redirect(reverse('queriesapp:book'))
        # return redirect(reverse('queriesapp:book', kwargs={'pk': book_to_update.id}))
        template = 'books/detail.html'
        return render(request, template, {'book': book_to_update})
